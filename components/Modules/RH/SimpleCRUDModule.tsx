            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              {isFunctions && (
                <div className="space-y-1">
                  ...
                  <input required value={formData.cbo || ''} onChange={e => setFormData({...formData, cbo: e.target.value})} className="w-full bg-emerald-50 border border-emerald-100 p-3 rounded-xl font-bold text-sm" />
                </div>
              )}
              {isRoles && (
                <div className="space-y-1">
